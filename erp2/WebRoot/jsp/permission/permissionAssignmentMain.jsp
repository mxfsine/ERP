  ...
  <head>
	...
	<script type="text/javascript">
		...
		function savePermission(){
			var selections=$function.treegrid('getSelections');//获取所有选中的权限行
			var selectionRole=$role.datagrid('getSelected');//获取选中的角色
		...
		function updRowsOpenDlg() {
			var row = $role.datagrid('getSelected');//得到选中的行
			if (row) {
				parent.$.modalDialog({//自定义Dialog，弹出子窗口
					title : "编辑角色",
					width : 600,
					height : 400,
