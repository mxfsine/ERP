...
public class FunctionServiceImpl  implements FunctionService
{
	...
	*/
	public boolean persistenceFunction(Permission permission ) {
		Integer userId = Constants.getCurrendUser().getUserId();//得到当前用户ID
		if (null==permission.getPermissionId()||"".equals(permission.getPermissionId()))//判断权限ID是否为空
		{
